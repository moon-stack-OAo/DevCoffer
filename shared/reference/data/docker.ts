  ...
  "data": [
    {
      ...
      "items": [
        ...
        {
          "cmd": "docker run -d --name nginx -p 80:80 nginx",
          "desc": "运行容器"
        },
        {
          "cmd": "docker start/stop/restart name",
          "desc": "启停容器"
        },
        {
          "cmd": "docker rm name",
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "cmd": "kubectl port-forward pod 8080:80",
          "desc": "端口转发"
        }
      ]
    }
