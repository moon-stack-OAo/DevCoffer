    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "新生代最小比例（默认 5%）",
          "examples": [
            "java -XX:+UseG1GC -XX:G1NewSizePercent=10 MyApp"
          ],
          "returns": "新生代最小比例"
        },
        {
          ...
          "desc": "新生代最大比例（默认 60%）",
          "examples": [
            "java -XX:+UseG1GC -XX:G1MaxNewSizePercent=50 MyApp"
          ],
          "returns": "新生代最大比例"
        },
        {
          ...
          "desc": "混合 GC 目标次数",
          "examples": [
            "java -XX:+UseG1GC -XX:G1MixedGCCountTarget=16 MyApp"
          ],
          "returns": "混合 GC 次数"
        },
        {
        ...
        },
        {
          ...
          "desc": "预留内存比例（防止晋升失败）",
          "examples": [
            "java -XX:+UseG1GC -XX:G1ReservePercent=15 MyApp"
          ],
          "returns": "预留比例"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "软性堆上限（ZGC 特有）",
          "examples": [
            "java -XX:+UseZGC -XX:SoftMaxHeapSize=8g MyApp"
          ],
          "returns": "软性堆上限"
        },
        {
          ...
          "desc": "分配尖峰容忍度",
          "examples": [
            "java -XX:+UseZGC -XX:ZAllocationSpikeTolerance=2.0 MyApp"
          ],
          "returns": "容忍度因子"
        },
        {
          ...
          "desc": "主动 GC 间隔（秒）",
          "examples": [
            "java -XX:+UseZGC -XX:ZCollectionInterval=5 MyApp"
          ],
          "returns": "GC 间隔"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "并发 GC 线程数",
          "examples": [
            "java -XX:+UseG1GC -XX:ConcGCThreads=4 MyApp"
          ],
          "returns": "并发线程数"
        },
        {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "输出堆详细信息",
          "examples": [
            "java -Xlog:gc+heap=debug:file=heap.log MyApp"
          ],
          "returns": "堆详情日志"
        },
        {
          ...
          "desc": "输出 GC 各阶段耗时",
          "examples": [
            "java -Xlog:gc+phases=debug:file=phases.log MyApp"
          ],
          "returns": "GC 阶段日志"
        },
        {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "可视化分析 GC 日志",
          "examples": [
            "java -jar gcviewer.jar gc.log gc-report.pdf"
          ],
          "returns": "GC 分析报告"
        },
        {
