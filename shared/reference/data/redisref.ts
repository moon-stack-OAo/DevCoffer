  ...
  "data": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "设置字符串值并指定过期秒数",
          "examples": [
            "SETEX session:abc 3600 \"token-xyz\""
          ],
          "returns": "OK",
          "complexity": "O(1)"
        },
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "对字段值原子自增",
          "examples": [
            "HINCRBY user:1001:stat loginCount 1"
          ],
          "returns": "递增后的整数值",
          "complexity": "O(1)"
        },
        {
          ...
          "desc": "字段不存在时才设置",
          "examples": [
            "HSETNX user:1001 firstLogin \"2026-06-23\""
          ],
          "returns": "1 / 0",
          "complexity": "O(1)"
        }
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "examples": [
            "LINSERT log:user BEFORE \"login\" \"logout\""
          ],
        ...
        },
        {
          ...
          "desc": "原子地从一端弹出并推入另一端",
          "examples": [
            "LMOVE queue:wait queue:run RIGHT LEFT"
          ],
          "returns": "弹出元素 / nil",
          "complexity": "O(1)"
        },
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "desc": "将交集结果保存到新集合",
          "examples": [
            "SINTERSTORE tag:common tag:java tag:backend"
          ],
          "returns": "结果集元素数",
          "complexity": "O(N*M)"
        },
        {
          ...
          "desc": "将元素从一个集合移到另一个",
          "examples": [
            "SMOVE tag:java tag:backend \"spring\""
          ],
          "returns": "1 / 0",
          "complexity": "O(1)"
        }
      ...
      "items": [
        {
          ...
          "examples": [
            "ZADD rank:game 100 \"alice\" 200 \"bob\""
          ],
          "returns": "新增元素数",
          "complexity": "O(log N)"
        },
